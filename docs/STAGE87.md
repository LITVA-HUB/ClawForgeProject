# STAGE 87 — Subagent context carryover controls
...
- Added Stage 87 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage87_agents_parity.sh
- Gate validates:
