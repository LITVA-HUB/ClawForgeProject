# STAGE 117 — Subagent context carryover controls
...
- Added Stage 117 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage117_agents_parity.sh
- Gate validates:
