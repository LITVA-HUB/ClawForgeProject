# STAGE 97 — Subagent context carryover controls
...
- Added Stage 97 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage97_agents_parity.sh
- Gate validates:
