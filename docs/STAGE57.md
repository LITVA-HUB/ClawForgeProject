# STAGE 57 — Subagent context carryover controls
...
- Added Stage 57 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage57_agents_parity.sh
- Gate validates:
