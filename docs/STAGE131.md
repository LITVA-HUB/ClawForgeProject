# STAGE 131 — Json-first CLI output normalization
...
- Added Stage 131 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage131_agents_parity.sh
- Gate validates:
