# STAGE 81 — Json-first CLI output normalization
...
- Added Stage 81 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage81_agents_parity.sh
- Gate validates:
