# STAGE 51 — Json-first CLI output normalization
...
- Added Stage 51 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage51_agents_parity.sh
- Gate validates:
