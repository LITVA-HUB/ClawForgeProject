# STAGE 75 — Agents run lifecycle parity scaffolding
...
- Added Stage 75 parity artifact and gate for agents run lifecycle parity scaffolding.
...
## Smoke / gate
- Added scripts/smoke_stage75_agents_parity.sh
- Gate validates:
