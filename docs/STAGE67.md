# STAGE 67 — Subagent context carryover controls
...
- Added Stage 67 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage67_agents_parity.sh
- Gate validates:
