# STAGE 70 — Task cancellation/transition determinism
...
- Added Stage 70 parity artifact and gate for task cancellation/transition determinism.
...
## Smoke / gate
- Added scripts/smoke_stage70_agents_parity.sh
- Gate validates:
