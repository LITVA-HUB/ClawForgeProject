# STAGE 61 — Json-first CLI output normalization
...
- Added Stage 61 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage61_agents_parity.sh
- Gate validates:
