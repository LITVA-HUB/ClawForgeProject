# STAGE 85 — Agents run lifecycle parity scaffolding
...
- Added Stage 85 parity artifact and gate for agents run lifecycle parity scaffolding.
...
## Smoke / gate
- Added scripts/smoke_stage85_agents_parity.sh
- Gate validates:
