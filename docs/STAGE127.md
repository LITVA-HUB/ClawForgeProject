# STAGE 127 — Subagent context carryover controls
...
- Added Stage 127 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage127_agents_parity.sh
- Gate validates:
