# STAGE 111 — Json-first CLI output normalization
...
- Added Stage 111 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage111_agents_parity.sh
- Gate validates:
