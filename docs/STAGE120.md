# STAGE 120 — Task cancellation/transition determinism
...
- Added Stage 120 parity artifact and gate for task cancellation/transition determinism.
...
## Smoke / gate
- Added scripts/smoke_stage120_agents_parity.sh
- Gate validates:
