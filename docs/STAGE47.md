# STAGE 47 — Subagent context carryover controls
...
- Added Stage 47 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage47_agents_parity.sh
- Gate validates:
