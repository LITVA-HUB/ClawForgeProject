# STAGE 41 — Json-first CLI output normalization
...
- Added Stage 41 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage41_agents_parity.sh
- Gate validates:
