# STAGE 99 — Run events/query pagination semantics
...
- Added Stage 99 parity artifact and gate for run events/query pagination semantics.
...
## Smoke / gate
- Added scripts/smoke_stage99_agents_parity.sh
- Gate validates:
