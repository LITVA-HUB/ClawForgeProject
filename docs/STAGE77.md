# STAGE 77 — Subagent context carryover controls
...
- Added Stage 77 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage77_agents_parity.sh
- Gate validates:
