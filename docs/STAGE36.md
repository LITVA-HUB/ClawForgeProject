# STAGE 36 — Agents run stop/log/info/send compatibility stubs
...
- Added Stage 36 parity artifact and gate for agents run stop/log/info/send compatibility stubs.
...
## Smoke / gate
- Added scripts/smoke_stage36_agents_parity.sh
- Gate validates:
