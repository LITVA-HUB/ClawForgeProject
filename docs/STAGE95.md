# STAGE 95 — Agents run lifecycle parity scaffolding
...
- Added Stage 95 parity artifact and gate for agents run lifecycle parity scaffolding.
...
## Smoke / gate
- Added scripts/smoke_stage95_agents_parity.sh
- Gate validates:
