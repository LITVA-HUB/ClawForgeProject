# STAGE 122 — Gateway-call compatibility envelopes
...
- Added Stage 122 parity artifact and gate for gateway-call compatibility envelopes.
...
## Smoke / gate
- Added scripts/smoke_stage122_agents_parity.sh
- Gate validates:
