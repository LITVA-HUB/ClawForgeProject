# STAGE 129 — Run events/query pagination semantics
...
- Added Stage 129 parity artifact and gate for run events/query pagination semantics.
...
## Smoke / gate
- Added scripts/smoke_stage129_agents_parity.sh
- Gate validates:
