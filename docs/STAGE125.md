# STAGE 125 — Agents run lifecycle parity scaffolding
...
- Added Stage 125 parity artifact and gate for agents run lifecycle parity scaffolding.
...
## Smoke / gate
- Added scripts/smoke_stage125_agents_parity.sh
- Gate validates:
