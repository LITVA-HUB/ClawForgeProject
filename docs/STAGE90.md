# STAGE 90 — Task cancellation/transition determinism
...
- Added Stage 90 parity artifact and gate for task cancellation/transition determinism.
...
## Smoke / gate
- Added scripts/smoke_stage90_agents_parity.sh
- Gate validates:
