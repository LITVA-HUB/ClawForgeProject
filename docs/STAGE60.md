# STAGE 60 — Task cancellation/transition determinism
...
- Added Stage 60 parity artifact and gate for task cancellation/transition determinism.
...
## Smoke / gate
- Added scripts/smoke_stage60_agents_parity.sh
- Gate validates:
