# STAGE 107 — Subagent context carryover controls
...
- Added Stage 107 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage107_agents_parity.sh
- Gate validates:
