# STAGE 40 — Task cancellation/transition determinism
...
- Added Stage 40 parity artifact and gate for task cancellation/transition determinism.
...
## Smoke / gate
- Added scripts/smoke_stage40_agents_parity.sh
- Gate validates:
