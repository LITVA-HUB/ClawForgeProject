# STAGE 91 — Json-first CLI output normalization
...
- Added Stage 91 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage91_agents_parity.sh
- Gate validates:
