# STAGE 35 — Agents run lifecycle parity scaffolding
...
- Added Stage 35 parity artifact and gate for agents run lifecycle parity scaffolding.
...
## Smoke / gate
- Added scripts/smoke_stage35_agents_parity.sh
- Gate validates:
