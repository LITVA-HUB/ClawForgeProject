# STAGE 71 — Json-first CLI output normalization
...
- Added Stage 71 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage71_agents_parity.sh
- Gate validates:
