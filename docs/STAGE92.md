# STAGE 92 — Gateway-call compatibility envelopes
...
- Added Stage 92 parity artifact and gate for gateway-call compatibility envelopes.
...
## Smoke / gate
- Added scripts/smoke_stage92_agents_parity.sh
- Gate validates:
