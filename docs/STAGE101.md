# STAGE 101 — Json-first CLI output normalization
...
- Added Stage 101 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage101_agents_parity.sh
- Gate validates:
