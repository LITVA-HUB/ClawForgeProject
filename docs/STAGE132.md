# STAGE 132 — Gateway-call compatibility envelopes
...
- Added Stage 132 parity artifact and gate for gateway-call compatibility envelopes.
...
## Smoke / gate
- Added scripts/smoke_stage132_agents_parity.sh
- Gate validates:
