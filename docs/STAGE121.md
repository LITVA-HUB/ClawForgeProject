# STAGE 121 — Json-first CLI output normalization
...
- Added Stage 121 parity artifact and gate for json-first CLI output normalization.
...
## Smoke / gate
- Added scripts/smoke_stage121_agents_parity.sh
- Gate validates:
