# STAGE 37 — Subagent context carryover controls
...
- Added Stage 37 parity artifact and gate for subagent context carryover controls.
...
## Smoke / gate
- Added scripts/smoke_stage37_agents_parity.sh
- Gate validates:
