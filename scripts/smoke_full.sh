...
scripts/smoke_stage121_agents_parity.sh >/dev/null
scripts/smoke_stage122_agents_parity.sh >/dev/null
scripts/smoke_stage123_agents_parity.sh >/dev/null
scripts/smoke_stage124_agents_parity.sh >/dev/null
scripts/smoke_stage125_agents_parity.sh >/dev/null
scripts/smoke_stage126_agents_parity.sh >/dev/null
scripts/smoke_stage127_agents_parity.sh >/dev/null
scripts/smoke_stage128_agents_parity.sh >/dev/null
scripts/smoke_stage129_agents_parity.sh >/dev/null
scripts/smoke_stage130_agents_parity.sh >/dev/null
scripts/smoke_stage131_agents_parity.sh >/dev/null
scripts/smoke_stage132_agents_parity.sh >/dev/null
scripts/smoke_stage133_agents_parity.sh >/dev/null
scripts/smoke_stage134_agents_parity.sh >/dev/null
